...
class Atri:
	...
	@property
	def Home(self):
		self._getter_access_tracker["Home"] = {}
		return self._Home
	@Home.setter
	def Home(self, new_state):
		self._setter_access_tracker["Home"] = {}
		global default_state
		self._Home = TextBox(new_state, default_state["Home"])
